    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(choices=[('CSE', 'CSE'), ('IT', 'IT'), ('ECE', 'ECE'), ('ELE', 'ELE'), ('CHE', 'CHE'), ('MME', 'MME'), ('BIOTECH', 'BIOTECH'), ('BIOMED', 'BIOMED')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('mentor_assigned', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.mentor')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
